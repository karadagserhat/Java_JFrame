...
public class Kare extends JPanel implements ActionListener, KeyListener{
	...
	int uzunluk = 50; //çizginin uzunluğu
	...
	private void kareKontrol() {
		...
		{
			kopyaAnaAlan = (Area)anaAlan.clone(); //kopyasını alıyoruz çünkü orjinalini değiştirmesin
			...
			{
				uzunluk += 5; // her küçük kareyi yuttuğumuz zaman kare büyür.
